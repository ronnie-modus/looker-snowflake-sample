view: _period_comparison {
  ...
  dimension: is_current_period {
    ...
    group_label: "Period Comparison"
    type: yesno
    sql: ${event_time} >= ${filter_start_date_raw} AND ${event_time} < ${filter_end_date_raw} ;;
  }
  ...
  dimension: is_comparison_period {
    ...
    group_label: "Period Comparison"
    type: yesno
    sql: ${event_time} >= ${comparison_period_start_date} AND ${event_time} < ${comparison_period_end_date} ;;
  }
